...
public:
  ...
  **/
  static std::string HashAnsiString(const TCHAR* String)
  {
    uint8 Digest[16];

    FMD5 Md5Gen;

    Md5Gen.Update((unsigned char*)(String), strlen(String));
    Md5Gen.Final(Digest);
...
struct FMD5Hash
{
  ...
  */
  ...
  static FMD5Hash HashFile(const TCHAR* InFilename, std::vector<uint8>* Buffer = nullptr);
...
private:
  ...
  friend std::string LexicalConversion::ToString(const FMD5Hash&);
