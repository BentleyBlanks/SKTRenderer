...
class TResourceArray
  ...
  , public std::vector<ElementType/*, TAlignedHeapAllocator<Alignment>*/ >
{
public:
  typedef std::vector<ElementType/*, TAlignedHeapAllocator<Alignment>*/ > Super;
...
#ifdef PLATFORM_COMPILER_HAS_DEFAULTED_FUNCTIONS
  ...
  */
  ...
  {
    return (u32)(this->size() * sizeof(ElementType));
  }
