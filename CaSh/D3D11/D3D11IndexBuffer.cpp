...
RBIndexBufferRHIRef FD3D11DynamicRHI::RHICreateIndexBuffer(uint32 Stride, uint32 Size, uint32 InUsage, RBRHIResourceCreateInfo& CreateInfo)
{
  ...
  return new RBD3D11IndexBuffer(IndexBufferResource, Stride, Size, InUsage);
}

void* FD3D11DynamicRHI::RHILockIndexBuffer(RBIndexBufferRHIParamRef IndexBufferRHI, uint32 Offset, uint32 Size, EResourceLockMode LockMode)
{
  RBD3D11IndexBuffer* IndexBuffer = (RBD3D11IndexBuffer*)(IndexBufferRHI);
...
void FD3D11DynamicRHI::RHIUnlockIndexBuffer(RBIndexBufferRHIParamRef IndexBufferRHI)
{
  RBD3D11IndexBuffer* IndexBuffer = (RBD3D11IndexBuffer*)(IndexBufferRHI);
