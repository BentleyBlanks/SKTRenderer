...
class CRFastApp_new : public FastApp
{
public:
  ...
  CRFastApp_new(class AppBase* app);
  virtual ~CRFastApp_new();
  CRFastApp_new(const CRFastApp_new& o) = delete;
  CRFastApp_new& operator=(const CRFastApp_new& o) = delete;
