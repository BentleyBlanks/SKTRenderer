...
RBStructuredBufferRHIRef FD3D11DynamicRHI::RHICreateStructuredBuffer(uint32 Stride, uint32 Size, uint32 InUsage, RBRHIResourceCreateInfo& CreateInfo)
{
  ...
  */
  ...
  return new RBD3D11StructuredBuffer(StructuredBufferResource, Stride, Size, InUsage);
}

void* FD3D11DynamicRHI::RHILockStructuredBuffer(RBStructuredBufferRHIParamRef StructuredBufferRHI, uint32 Offset, uint32 Size, EResourceLockMode LockMode)
{
  RBD3D11StructuredBuffer* StructuredBuffer = (RBD3D11StructuredBuffer*)(StructuredBufferRHI);
...
void FD3D11DynamicRHI::RHIUnlockStructuredBuffer(RBStructuredBufferRHIParamRef StructuredBufferRHI)
{
  RBD3D11StructuredBuffer* StructuredBuffer = (RBD3D11StructuredBuffer*)(StructuredBufferRHI);
